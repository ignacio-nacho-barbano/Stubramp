...
export const Positive: Story = { args: { tone: 'positive', children: 'Cleared' } };
export const Negative: Story = { args: { tone: 'negative', children: 'Declined' } };
...
export const Solid: Story = { args: { tone: 'positive', variant: 'solid', children: 'Cleared' } };
